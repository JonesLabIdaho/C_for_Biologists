...
public:
	...
	double p_pref_var;
	int p_loci_trt0, p_loci_trt1, p_loci_pleio;
...
public:
	...
	void update_parameter_values(parameter_value_set &parm_set)
	{
		...
		// Quantitative Genetic Parameters
		NumLociTrait0 = parm_set.p_loci_trt0;
		NumLociTrait1 = parm_set.p_loci_trt1;
		NumLociBoth = parm_set.p_loci_pleio;
